# -*- coding: utf-8 -*-
#
# pandokia documentation build configuration file, created by
...
release = open(os.path.dirname(__file__) + "/../version.txt","r").readline().strip()
